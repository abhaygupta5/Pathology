...
<?php
    ...
    $query="SELECT Test_Name,Test_type FROM tests;";
    $result=mysqli_query($con,$query);
echo "<table class='table'>
    <thead><tr><th scope='col'>#</th><th scope='col'>Test Name</th><th scope='col'>Test Type</th></tr></thead><tbody>";
$i=0;
while($a=mysqli_fetch_assoc($result)){
    echo "<tr><th scope='row'>".++$i."</th><td>".$a['Test_Name']."</td><td>".$a['Test_type']."</td></tr>";
}
echo "</tbody></table>";
