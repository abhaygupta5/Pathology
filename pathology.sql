...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2017 at 08:34 PM
...
--
-- Table structure for table `doc_tests`
--

CREATE TABLE `doc_tests` (
  `d_id` int(3) DEFAULT NULL,
  `aadhar_id` int(12) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `test_name` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `employee` (
  ...
  `Role` enum('Manager','Sorter','Lab Worker') COLLATE utf8_unicode_ci DEFAULT NULL,
  `DOB` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `report_to_patient` (
  `Report_Number` int(20) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `Aadhar_Id` int(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `doc_report`
  ADD PRIMARY KEY (`Aadhar_id`,`D_Id`,`date`),
  ADD KEY `D_Id` (`D_Id`),
  ADD KEY `User_Id` (`User_Id`);

--
-- Indexes for table `doc_tests`
--
ALTER TABLE `doc_tests`
  ADD KEY `aadhar_id` (`aadhar_id`,`d_id`,`date`);
...
--
ALTER TABLE `report`
  MODIFY `Report_Number` int(20) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `doc_tests`
--
ALTER TABLE `doc_tests`
  ADD CONSTRAINT `doc_tests_ibfk_1` FOREIGN KEY (`aadhar_id`,`d_id`,`date`) REFERENCES `doc_report` (`Aadhar_id`, `D_Id`, `date`);
...
--
ALTER TABLE `report`
  ADD CONSTRAINT `report_ibfk_1` FOREIGN KEY (`Test_Name`) REFERENCES `tests` (`Test_Name`),
  ADD CONSTRAINT `report_ibfk_2` FOREIGN KEY (`Lab_Id`) REFERENCES `lab` (`Lab_id`);
...
ALTER TABLE `sample_to_lab`
  ...
  ADD CONSTRAINT `sample_to_lab_ibfk_2` FOREIGN KEY (`Lab_Id`) REFERENCES `lab` (`Lab_id`),
  ADD CONSTRAINT `sample_to_lab_ibfk_3` FOREIGN KEY (`Aadhar_Id`) REFERENCES `patient` (`Aadhar_id`);

--
-- Constraints for table `sorts_test`
--
ALTER TABLE `sorts_test`
  ADD CONSTRAINT `sorts_test_ibfk_1` FOREIGN KEY (`Test_Name`) REFERENCES `tests` (`Test_Name`),
  ADD CONSTRAINT `sorts_test_ibfk_2` FOREIGN KEY (`User_Id`) REFERENCES `test_sorter` (`User_Id`);
